...
<div class="container py-5">
  ...
  <div class="product_data px-3 py-5  "  >
    ...
    <div class="col-md-4 animated fadeInRight fast product-container" style="width: 100%;">
                            ...
                            @endif
                              ...
                              <p>{{$Product->description}}</p>
                                ...
                                <input type="hidden"   name="product_id"   min=0 value="{{$Product->id}}" required class="form-control product_id">
                                   <p> Price : <strong style="font-size:20px;font-family: 'Balsamiq Sans', cursive;">PKR {{$Product->price}}</strong></p>
                              ...
                              <div class="col-md-12 my-3"  id="changethebuttons">
                                      ...
                                      <button class="btaobtn btaobtn-primary px-2 py-2 book-now-btn" >Order</button>
